...
import com.example.qiaop.xiangmu_zhihu.adapter.GankAdapter_IOS;
...
public class Gank_BFragment extends BaseFragment<GankView, GankPresenter<GankView>> implements GankView<String> {
    ...
    private GankAdapter_IOS gankAdapter_ios;
    private String imgB;
    public Gank_BFragment() {

    }
    public Gank_BFragment(String tech, String img) {
        tab = tech;
        imgB=img;
    }
    ...
    protected void initData() {
        Glide.with(this).load(imgB).into(imgAndroid);
        ...
        gankAdapter_ios = new GankAdapter_IOS(gank,getContext());
        LinearLayoutManager manager = new LinearLayoutManager(getContext());
        rv.setLayoutManager(manager);
        rv.setAdapter(gankAdapter_ios);
        gankAdapter_ios.setOnClickList(new GankAdapter_IOS.OnClickList() {
            @Override
    ...
    public void show(String s) {
        ...
        gank.addAll(results);
        gankAdapter_ios.notifyDataSetChanged();
