package com.example.qiaop.xiangmu_zhihu.http.zhihu;
...
//    Observable<WelcomeBean> getWelcomeInfo(@Path("res") String res);
     ...
     */
    @GET("story-extra/{id}")
    Observable<String> getDetailExtraInfo(@Path("id") String id);

    /**
     * 日报的长评论CommentBean
     */
    @GET("story/{id}/long-comments")
    Observable<String> getLongCommentInfo(@Path("id") String id);

    /**
     * 日报的短评论CommentBean
     */
    @GET("story/{id}/short-comments")
    Observable<String> getShortCommentInfo(@Path("id") String id);
