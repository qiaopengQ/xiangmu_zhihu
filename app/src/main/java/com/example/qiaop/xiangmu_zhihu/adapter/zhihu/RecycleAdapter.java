...
public class RecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        if (holder instanceof ViewHolder2){
            ...
            ((ViewHolder2) holder).itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onclickLienet.Click(String.valueOf(list.get(position).getId()),position);
                }
            });
    ...
    OnclickLienet onclickLienet;

    public void setOnclickLienet(OnclickLienet onclickLienet) {
        this.onclickLienet = onclickLienet;
    }

    public interface OnclickLienet{
        void Click(String id,int position);
    }
