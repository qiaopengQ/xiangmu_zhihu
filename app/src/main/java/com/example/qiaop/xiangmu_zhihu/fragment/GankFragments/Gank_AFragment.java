...
import com.example.qiaop.xiangmu_zhihu.adapter.GankAdapter;
...
import com.example.qiaop.xiangmu_zhihu.utils.SystemUtil;
...
public class Gank_AFragment extends BaseFragment<GankView, GankPresenter<GankView>> implements GankView<String> {
    ...
    protected void initData() {
        ...
        gankAdapter.setClickList(new GankAdapter.OnClickList() {
            @Override
